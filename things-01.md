...
```
...or for the **full** *Windows 10* default fonts directory, download following:
[Windows 10 Font Pack](https://drive.google.com/open?id=12_XdIuljvZVT7MwQ_ceYjqVdZ5FK45Yy)
Create `.fonts` folder in your home directory and unpack there your downloaded fonts. 
